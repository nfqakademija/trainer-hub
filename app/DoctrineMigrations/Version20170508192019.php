 ...
 */
class Version20170508192019 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, training_id INT DEFAULT NULL, INDEX IDX_4DA23919EB6921 (client_id), INDEX IDX_4DA239BEFD98D1 (training_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
